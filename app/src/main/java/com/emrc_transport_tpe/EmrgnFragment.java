 ...
 */
public class EmrgnFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_emrgn, container, false);
    }
...
//		 MainActivity.toast(emrgn, this);
    ...
    private void setMyAdapter(final int position) {
        View vi = LayoutInflater.from(getActivity()).inflate(R.layout.style_checkbox, null);
            ...
            if (treatment_list_click.get(i)) {
                ...
                switch (i) {
                    ...
                    case 30:
                        ...
                        break;
                    case 31:
                        tmp_string.add(getString(R.string.s_EMRGN_31) + getViewString_1(i)
                                + getString(R.string.s_ts_55));
                        break;
                    case 32:// --------------------------
    ...
    private void getListString(ArrayList<String> T, ArrayList<String> S) {
        if (S.size() > 0) {
            ...
            other2 += ")";
            MainActivity.info_data.add(other2);
            MainActivity.emrgn_txt = other;
            Toast.makeText(EmrgnFragment.this.getContext(), getString(R.string.s_ts_51), Toast.LENGTH_LONG).show();
        }
    }

...
public class WritePadDialog2 extends Dialog implements View.OnClickListener{

    Context context;
    WindowManager.LayoutParams p ;
    DialogListener dialogListener;
    private static Button btnOk,btnClear,btnCancel;
    private static FrameLayout frameLayout;

    public WritePadDialog2(Context context, DialogListener dialogListener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.write_pad2);
